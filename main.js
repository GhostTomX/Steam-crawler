...
MongoClient.connect(url, function (err, db) {
    ...
    superagent
        ...
        .end(function (err, res) {
            ...
            // var data = $(".search_result_row")[0].attribs;//注意： 由于class属性是我不需要的，所以我在后文将其删除。因此每次查询得到的最新的一个$(".search_result_row") 就是
            // // 获得href,appid
            ...
            // delete(data.class);
            // db.collection("steam_info").insert(data);
            //             };
            // //  console.log("dsds");
            // console.log("第1页完成，总共"+maxPage+"页");
            //////
