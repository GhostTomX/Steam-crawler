...
MongoClient.connect(url, function (err, db) {
    console.log('数据库已链接');
    superagent
        .get('http://store.steampowered.com/search/?sort_by=Released_DESC&page=1063')
        ...
        .end(function (err, res) {
            ...
            // for(var s =0;s<$("#search_result_container")[0].children.length;s++){
                var lastPage = $("#search_result_container")[0].children[5].children[0].data;
                console.log((lastPage==="该查询未传回任何结果。"));
            // if(lastPage.euqals(""));
        // }
            // try {
            ...
            //     maxPage = Number($(".search_pagination_right")[0].children[5].children[0].data);
            // };
            // n = 871; //开始的数字，默认为1，出现异常情况可以设成异常情况开始出重新开始
